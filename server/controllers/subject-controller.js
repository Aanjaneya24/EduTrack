...
const freeSubjectList = async (req, res) => {
    try {
        ...
        let allSubjects = await Subject.find({ sclassName: req.params.id });
        
        // Filter out subjects that have teachers assigned
        let subjects = allSubjects.filter(subject => !subject.teacher || subject.teacher === null);
