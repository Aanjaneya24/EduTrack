...
const deleteTeacher = async (req, res) => {
    try {
        ...
        // Remove teacher reference from subject by setting it to null
...
const deleteTeachers = async (req, res) => {
    try {
        // First, find all teachers to get their IDs
        ...
        // Remove teacher references from subjects by setting to null
